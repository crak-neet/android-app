...
<module external.linked.project.id=":react-native-fileupload" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-fileupload" />
      </configuration>
    </facet>
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: com.facebook.fresco:fbcore:0.6.1@aar" level="project" />
    <orderEntry type="library" name="Gradle: com.facebook.fresco:fresco:0.6.1@aar" level="project" />
    <orderEntry type="library" name="Gradle: com.parse.bolts:bolts-android:1.1.4@jar" level="project" />
    <orderEntry type="library" name="Gradle: com.squareup.okio:okio:1.5.0@jar" level="project" />
    ...
    <orderEntry type="library" name="Gradle: com.facebook.fresco:drawee:0.6.1@aar" level="project" />
    ...
    <orderEntry type="library" name="Gradle: com.squareup.okhttp:okhttp:2.4.0@jar" level="project" />
    <orderEntry type="library" name="Gradle: android.arch.lifecycle:common:1.0.0@jar" level="project" />
    <orderEntry type="library" name="Gradle: com.facebook.fresco:imagepipeline:0.6.1@aar" level="project" />
    ...
    <orderEntry type="library" name="Gradle: com.facebook.fresco:imagepipeline-okhttp:0.6.1@aar" level="project" />
    <orderEntry type="library" name="Gradle: com.android.support:support-compat:26.1.0@aar" level="project" />
    <orderEntry type="library" name="Gradle: com.facebook.react:react-native:0.15.3@aar" level="project" />
    <orderEntry type="library" name="Gradle: com.android.support:support-core-ui:26.1.0@aar" level="project" />
    <orderEntry type="library" name="Gradle: com.squareup.okhttp:okhttp-ws:2.4.0@jar" level="project" />
