...
import { wp } from '../../src/Asset/Libraries/ResponsiveScreen';
import styles from './style';
import BaseComponent from './BaseComponent';
...
export default class ModalPicker extends BaseComponent {
    ...
    renderOption(option) {
        return (
            <TouchableOpacity key={option.key} onPress={() => this.onChange(option)}>
                <View style={[styles.optionStyle, this.props.optionStyle]}>
                    <Text numberOfLines={2} style={[styles.optionTextStyle, this.props.optionTextStyle]}>{option.label}</Text>
                </View>
            </TouchableOpacity>)
    }
        ...
        return (
            <View style={[styles.overlayStyle, this.props.overlayStyle]} key={'modalPicker' + (componentIndex++)}>
                <View style={styles.optionContainer}>
                    ...
                    <View style={{ height: width / 100 * 2 }} />
                    {/* <View > */}
                    <TouchableOpacity onPress={this.close} style={[styles.cancelContainer]}>
                        <View style={[styles.cancelStyle, this.props.cancelStyle]}>
                            <Text style={[styles.cancelTextStyle, this.props.cancelTextStyle]}>{this.props.cancelText}</Text>
                        </View>
                    </TouchableOpacity>
    ...
    render() {
        ...
        return (
            <View style={this.props.style}>
                ...
                <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'center' }} onPress={this.open}>
                    <View style={{ flex: 0.9, justifyContent: 'center' }}>
                        {this.renderChildren()}
                    </View>
                    <View style={{ flex: 0.1, justifyContent: 'center', alignItems: 'flex-start' }}>
                        <Image source={require('./../../src/Asset/Icons/caret-down.png')} style={{ tintColor: 'grey', height: wp('4%'), width: wp('4%') }} />
                    </View>
                </TouchableOpacity>
            </View>
        );
