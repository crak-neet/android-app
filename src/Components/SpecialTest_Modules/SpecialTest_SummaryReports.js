...
class SpecialTest_SummaryReports extends Component {
 ...
 // TestTypeId :
        ...
        this.props.AllSummaryDetailsReportAction(this.state.token, SummaryreportDetail_SummaryId, "5")
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View style={{ flex: 1, backgroundColor: color.white, }}>
                    ...
                    <View style={{ height: hp('70%'), marginTop: hp('5%'), marginLeft: wp('5%'), marginRight: wp('5%'), borderWidth: wp('0.2%'), borderRadius: wp('3%') }}>
                        <View style={{ height: hp('24%'), justifyContent: 'center' }}>
                            ...
                            <View style={{ height: hp('5%'), justifyContent: 'center', flexDirection: 'row', marginTop: hp('1%') }}>
                                <View style={{ flex: 4.5, justifyContent: 'center', borderBottomWidth: hp('0.1%'), marginLeft: wp('4%'), borderBottomColor: color.lightGray, flexDirection: 'row' }}>
                                    ...
                                    <View style={{ flex: 7, justifyContent: 'center' }}>
                                        {/* <Text style={{ fontSize: fontSize.verySmall, fontFamily: fontFamily.OpenSansRegular, color: color.black }}>{SummaryreportDetail[0].TestId}</Text> */}
                            ...
                            <View style={{ height: hp('5%'), justifyContent: 'center', flexDirection: 'row', borderBottomWidth: hp('0.1%'), marginLeft: wp('4%'), borderBottomColor: color.lightGray, marginRight: wp('4%'), marginTop: hp('1%') }}>
                                {/* <View style={{ flex: 4.5, justifyContent: 'center', borderBottomWidth: hp('0.1%'), marginLeft: wp('4%'), borderBottomColor: color.lightGray, flexDirection: 'row' }}> */}
                        ...
                        <View style={{ height: hp('36%'), justifyContent: 'center', backgroundColor: '#ebebeb', marginTop: hp('1%'), borderBottomLeftRadius: wp('3.1%'), borderBottomRightRadius: wp('3%') }}>
