...
class SpecialTestStartUp extends Component {
    constructor() {
    ...
    render() {
        ...
        return (
            ...
            <View style={{ flex: 1, backgroundColor: "#F7F7F7", }}>
                ...
                {/* <Header_BackIcon onPressLeftIcon={() => this.backIconPress()} HeaderText='Special Test' /> */}
...
export default connect(mapStateToProps, mapDispatchToProps)(SpecialTestStartUp);
