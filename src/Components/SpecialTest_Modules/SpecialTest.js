...
class SpecialTest extends Component {
    ...
    render() {
        const { specialTestList, Examvalidation,isFetchingStartSpcl } = this.props.NeetReducer
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View style={{ flex: 1, backgroundColor: color.white, }}>
                    ...
                    <View style={{ flex: 0.35, justifyContent: 'center', alignItems: 'center', }}>
                        <Image source={require('../../Asset/Icons/019-test-1.png')} style={{ height: wp('35%'), width: wp('35%'), tintColor: color.appGreen }} />
                    </View>
