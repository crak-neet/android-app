                    ...
                    <View>
                        ...
                        <View style={{ height: hp('11%'), flexDirection: 'row', marginLeft: wp('8%'), marginRight: wp('8%'), borderRadius: wp('3%'), borderColor: color.appGreen, borderWidth: wp('0.2%') }} >
                            <View style={{ flex: 0.3, justifyContent: 'center', alignItems: 'center', backgroundColor: color.appGreen, borderTopLeftRadius: wp('3%'), borderBottomLeftRadius: wp('3%') }}>
                                <Image source={require('../../Asset/Icons/003-education.png')} style={{ height: hp('6%'), width: hp('6%'), tintColor: color.white }} />
                            </View>
                        ...
                        <View style={{ height: hp('11%'), flexDirection: 'row', marginLeft: wp('8%'), marginRight: wp('8%'), borderRadius: wp('3%'), borderColor: color.appGreen, borderWidth: wp('0.2%'), marginTop: hp('2%') }} >
                            <View style={{ flex: 0.3, justifyContent: 'center', alignItems: 'center', backgroundColor: color.appGreen, borderTopLeftRadius: wp('3%'), borderBottomLeftRadius: wp('3%') }}>
                                <Image source={require('../../Asset/Icons/books-stack-of-three.png')} style={{ height: hp('6.5%'), width: hp('6.5%'), tintColor: color.white }} />
                            </View>
                            <View style={{ flex: 0.7, justifyContent: 'center' }}>
                        ...
                        <View style={{ height: hp('11%'), flexDirection: 'row', marginLeft: wp('8%'), marginRight: wp('8%'), borderRadius: wp('3%'), borderColor: color.appGreen, borderWidth: wp('0.2%'), marginTop: hp('2%') }} >
                            <View style={{ flex: 0.3, justifyContent: 'center', alignItems: 'center', backgroundColor: color.appGreen, borderTopLeftRadius: wp('3%'), borderBottomLeftRadius: wp('3%') }}>
                                <Image source={require('../../Asset/Icons/004-exam.png')} style={{ height: hp('6%'), width: hp('6%'), tintColor: color.white }} />
                            </View>
                            <View style={{ flex: 0.7, justifyContent: 'center' }}>
                        ...
                        <View style={{ height: hp('11%'), flexDirection: 'row', marginLeft: wp('8%'), marginRight: wp('8%'), borderRadius: wp('3%'), borderColor: color.appGreen, borderWidth: wp('0.2%'), marginTop: hp('2%') }} >
                            <View style={{ flex: 0.3, justifyContent: 'center', alignItems: 'center', backgroundColor: color.appGreen, borderTopLeftRadius: wp('3%'), borderBottomLeftRadius: wp('3%') }}>
                                <Image source={require('../../Asset/Icons/017-exam-2.png')} style={{ height: hp('6%'), width: hp('6%'), tintColor: color.white }} />
                            </View>
                            <View style={{ flex: 0.7, justifyContent: 'center' }}>
                        ...
                        <View style={{ height: hp('11%'), flexDirection: 'row', marginLeft: wp('8%'), marginRight: wp('8%'), borderRadius: wp('3%'), borderColor: color.appGreen, borderWidth: wp('0.2%'), marginTop: hp('2%') }} >
                            <View style={{ flex: 0.3, justifyContent: 'center', alignItems: 'center', backgroundColor: color.appGreen, borderTopLeftRadius: wp('3%'), borderBottomLeftRadius: wp('3%') }}>
                                <Image source={require('../../Asset/Icons/019-test-1.png')} style={{ height: hp('6%'), width: hp('6%'), tintColor: color.white }} />
                            </View>
                            <View style={{ flex: 0.7, justifyContent: 'center' }}>
