...
class SubjectTestStartUp extends Component {
    constructor() {
                ...
                <View style={{ flex: 1, marginLeft: wp('5%'), marginRight: wp('5%'), marginTop: hp('3%'), marginBottom: hp('3%'), borderRadius: wp('3%'), borderColor: color.lightGray, borderWidth: wp("0.2%"), }}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <View style={{ flex: 1, justifyContent: 'center', flexDirection: 'row', marginBottom: hp('1%') }}>
                                ...
                                <View style={{ flex: 0.92 }}>
                                    <Text style={{ fontSize: fontSize.Small, color: color.black, fontFamily: fontFamily.OpenSansRegular, }}>If you fail to submit within 24 hours the test will be submitted automatically.</Text>
                                </View>
                            </View>
                            <View style={{ flex: 1, justifyContent: 'center', flexDirection: 'row', marginBottom: hp('1%') }}>
                                <View style={{ flex: 0.08 }}>
                            ...
                            <View style={{ height: hp('1%'), justifyContent: 'center', }} />
                        </ScrollView>
                    </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(SubjectTestStartUp);
