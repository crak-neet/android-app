...
class SubjectTest_SummaryReports extends Component {
    constructor() {
    ...
    onViewDetail() {
        ...
        this.props.AllSummaryDetailsReportAction(this.state.token, SummaryreportDetail_SummaryId, "2")
...
export default connect(mapStateToProps, mapDispatchToProps)(SubjectTest_SummaryReports);
