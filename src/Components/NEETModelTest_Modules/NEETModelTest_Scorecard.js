...
class NEETModelTest_Scorecard extends Component {
    constructor() {
    ...
    onReports(Summary_ID) {
        ...
        // TypeId =>4 Neet
        // TypeId =>5 Special 
        this.props.AllSummaryDetailsReportAction(this.state.token, Summary_ID, "4")
        // this.props.navigation.navigate("NEETModelTest_Reports")
    }

    render() {
        const { quickReportModelTest } = this.props.NeetReducer
            ...
            <View style={{ flex: 1, backgroundColor: color.white, }}>
                ...
                <View style={{ height: hp('6%'), flexDirection: 'row', marginLeft: wp('5%'), marginRight: wp('5%'), marginTop: hp('1%'), borderBottomWidth: hp('0.1%'), borderColor: color.lightGray }}>
                    <View style={{ flex: 2, justifyContent: 'center', alignItems: 'center' }}>
                        <Image source={require('../../Asset/Icons/017-exam-2.png')} style={{ height: hp('3%'), width: hp('3%'), tintColor: color.appGreen }} />
                    </View>
                ...
                <View style={{ height: hp('20%'), justifyContent: 'center', marginTop: hp('2%'), alignItems: 'center' }}>
                    <Image source={{ uri: quickReportModelTest.StudentProfile }} style={{ height: hp('16%'), width: hp('16%'), borderRadius: hp("8%"), borderColor: color.lightGray, borderWidth: wp("0.2%") }} />
                </View>
                <View style={{ height: hp('4%'), marginLeft: wp('8%'), marginRight: wp('8%'), justifyContent: 'center' }}>
                    <Text style={{ fontSize: fontSize.Small, fontFamily: fontFamily.OpenSansSemiBold, color: color.lightGray, textAlign: 'center' }}>{quickReportModelTest.StudentName}</Text>
                </View>
                <View style={{ height: hp('32%'), justifyContent: 'center', backgroundColor: "#ebebeb", marginLeft: wp('6%'), marginRight: wp('6%'), borderWidth: hp('0.1%'), borderRadius: wp('3%'), marginTop: hp('3%'), }}>
                    {/* <View style={{ flex: 0.5, flexDirection: 'row', marginTop: hp('2%') }}>
                        ...
                        <View style={{ flex: 4.8, marginLeft: wp('3%'), justifyContent: 'flex-start' }}>
                            <Text style={{ fontSize: fontSize.verySmall, fontFamily: fontFamily.OpenSansRegular, color: color.lightGray }}>{quickReportModelTest.TestId}</Text>
                        </View>
                    </View> */}
                    <View style={{ flex: 0.5, flexDirection: 'row', marginTop: hp('2.5%') }}>
                        ...
                        <View style={{ flex: 4.8, marginLeft: wp('3%'), justifyContent: 'flex-start' }}>
                            <Text style={{ fontSize: fontSize.verySmall, fontFamily: fontFamily.OpenSansRegular, color: color.lightGray }}>{quickReportModelTest.TestName}</Text>
                        </View>
                    </View>
                    <View style={{ flex: 0.5, flexDirection: 'row' }}>
                        ...
                        <View style={{ flex: 4.8, marginLeft: wp('3%'), justifyContent: 'flex-start' }}>
                            <Text style={{ fontSize: fontSize.verySmall, fontFamily: fontFamily.OpenSansRegular, color: color.lightGray }}>{quickReportModelTest.StudentMarks}</Text>
                        </View>
                    </View>
                    <View style={{ flex: 0.5, flexDirection: 'row' }}>
                        <View style={{ flex: 4.8, justifyContent: 'flex-start', marginLeft: wp('5%') }}>
                        ...
                        <View style={{ flex: 4.8, marginLeft: wp('3%'), justifyContent: 'flex-start' }}>
                            <Text style={{ fontSize: fontSize.verySmall, fontFamily: fontFamily.OpenSansRegular, color: color.lightGray }}>{quickReportModelTest.TotalMarks}</Text>
                        </View>
                    </View>
                    <View style={{ flex: 0.5, flexDirection: 'row' }}>
                        <View style={{ flex: 4.8, justifyContent: 'flex-start', marginLeft: wp('5%') }}>
                        ...
                        <View style={{ flex: 4.8, marginLeft: wp('3%'), justifyContent: 'flex-start' }}>
                            <Text style={{ fontSize: fontSize.verySmall, fontFamily: fontFamily.OpenSansRegular, color: color.lightGray }}>{quickReportModelTest.Grade}</Text>
                        </View>
                    </View>
                    <View style={{ flex: 0.5, flexDirection: 'row', }}>
                        <View style={{ flex: 4.8, justifyContent: 'flex-start', marginLeft: wp('5%') }}>
                        ...
                        <View style={{ flex: 4.8, marginLeft: wp('3%'), justifyContent: 'flex-start' }}>
                            <Text style={{ fontSize: fontSize.verySmall, fontFamily: fontFamily.OpenSansRegular, color: color.lightGray }}>{quickReportModelTest.Result}</Text>
                        </View>
                    </View>
                    <View style={{ height: hp('0.3%'), }} />
                </View>
                <View style={{ height: hp('6%'), }} />
                <Button OnButtonClicked={() => this.props.skipDebounce ? this.props.onReports : this.onReports(quickReportModelTest.TestDetailId)} ButtonText='Detailed Report' />
                <View style={{ height: hp('6%'), }} />
...
export default connect(mapStateToProps, mapDispatchToProps)(NEETModelTest_Scorecard);
