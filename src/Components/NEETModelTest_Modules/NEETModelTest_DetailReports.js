...
import { onClarificationAction } from './../../Redux/Actions/onClarificationAction';
import { ImageAnswerAction } from './../../Redux/Actions/ImageAnswerAction';

class NEETModelTest_DetailReports extends Component {
    constructor() {
    ...
    onClarification(TestDetailId, AnswerId) {
        this.props.onClarificationAction(this.state.token, TestDetailId, AnswerId)
    }
    onRequestClose() {
        this.setState({
            Question_ImageModel: false,
    ...
    render() {
        ...
        return (
            ...
            <View style={{ flex: 1, backgroundColor: "#F7F7F7", }}>
                ...
                <View style={{ flex: 8, marginLeft: wp('1%'), marginRight: wp('1%'), justifyContent: 'center', }}>
                                ...
                                <View style={{ flex: 1, backgroundColor: "#ebebeb", flexDirection: 'column', justifyContent: 'center', margin: wp('2.5%'), borderColor: color.lightGray, borderWidth: wp('0.2'), borderRadius: wp('3%') }}>
                                    {
                                        ViewSummaryreportDetail[this.state.QuestionIndex].OptionSelectedId == null ?
                                            <View style={{ height: hp('4%'), justifyContent: 'center', marginTop: hp('1%'), }}>
                                                <Text style={{ fontSize: fontSize.verySmall, color: color.appRed, fontFamily: fontFamily.OpenSansRegular, textAlign: 'center', textDecorationLine: 'underline', }}>Unanswered Question</Text>
                                            </View>
                                            : null}
                                                    ...
                                                    QuestionOptions.OptionValue.startsWith("https://www.crakneet.com/superadmin/uploads/QA_images/") ?
                                                        ...
                                                        <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'center', marginTop: wp("2%") }}>
                                                            ...
                                                            <View style={{ flex: 0.1, justifyContent: 'center' }}>
                                                                {
                                                                    QuestionOptions.OptionId == ViewSummaryreportDetail[this.state.QuestionIndex].OptionSelectedId && QuestionOptions.OptionId == ViewSummaryreportDetail[this.state.QuestionIndex].CorrectOptionId ?
                ...
                <View style={{ flex: 1, justifyContent: 'center' }}>
                    <TouchableOpacity onPress={() => this.props.skipDebounce ? this.props.onClarification : this.onClarification(ViewSummaryreportDetail[this.state.QuestionIndex].TestDetailId, ViewSummaryreportDetail[this.state.QuestionIndex].AnswerId)} style={{ height: hp('7%'), justifyContent: 'center', flexDirection: 'row', backgroundColor: color.appRed, alignItems: 'center', borderRadius: hp("3.5"), marginLeft: wp('10%'), marginRight: wp('10%') }}>
                        <View style={{ flex: 0.3, justifyContent: 'center', alignItems: 'center', }}>
                            <Image source={require('../../Asset/Icons/raise-your-hand-to-ask.png')} style={{ height: hp('4%'), width: hp('4%'), marginLeft: wp('7%'), tintColor: color.white }} />
                        </View>
                        <View style={{ flex: 0.7, justifyContent: 'center', }}>
                            <Text style={{ fontSize: fontSize.lightMedium, color: color.white, fontFamily: fontFamily.OpenSansSemiBold }}>Need Clarification</Text>
                        </View>
                    </TouchableOpacity>
                </View>
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        onClarificationAction: (Token, TestDetailId, AnswerId) => {
            dispatch(onClarificationAction(Token, TestDetailId, AnswerId));
        },
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(NEETModelTest_DetailReports);
