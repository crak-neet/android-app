...
class NEETModelTest_SummaryReports extends Component {
    constructor() {
    ...
    onViewDetail() {
        ...
        this.props.AllSummaryDetailsReportAction(this.state.token, SummaryreportDetail_SummaryId, "4")
...
export default connect(mapStateToProps, mapDispatchToProps)(NEETModelTest_SummaryReports);
