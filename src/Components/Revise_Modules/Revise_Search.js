    ...
    render() {
        ...
        return (
            ...
            <View style={{ flex: 1, backgroundColor: color.white, }}>
                ...
                <Header_Only_Drawer onPressLeftIcon={() => this.props.navigation.navigate('DrawerOpen')} HeaderText='Incorrectly Answered Questions' />
                ...
                <View style={{ height: hp('50%'), marginLeft: wp('5%'), marginRight: wp('5%'), borderWidth: hp('0.1%'), borderColor: color.lightGray, marginTop: hp('5%'), borderRadius: wp('3%'), backgroundColor: '#ebebeb' }}>
                    ...
                    <View style={{ height: hp('6%'), justifyContent: 'center', alignItems: 'center' }}>
                        <Text style={{ color: color.lightGray, fontSize: fontSize.Small, fontFamily: fontFamily.OpenSansRegular, textAlign: 'center' }}>Get Your Incorrectly Answered Questions Report</Text>
                    </View>
